    ...
    return (
        <>
            ...
            <div className="history-page">
                {/* HERO SECTION - REWRITTEN TO BE SAFE */}
                <div className="hero-section text-center text-white d-flex align-items-center justify-content-center"
                    style={{
                        ...
                        height: '70vh', // Reduced height a bit
                        marginTop: '0'
                    }}>
                    <Container>
                ...
                <div style={{ backgroundColor: '#f8f9fa' }}>
                    ...
                    {/* QUOTE BANNER - SAFE BACKGROUND */}
                    <div className="py-5 text-center text-white my-5"
                        style={{ backgroundColor: '#0d6efd', position: 'relative' }}>
                    ...
                    {/* SECTION 4: LEGACY & PRESENT - 2 COLUMNS SAFE LAYOUT */}
                    {/* SECTION 4: PRESENT & FUTURE */}
                    <Container className="py-5">
                    ...
                    <div className="py-5 mb-5 bg-dark text-white position-relative">
                        <Container className="position-relative z-2 py-4">
                            <div className="text-center mx-auto" style={{ maxWidth: '900px' }}>
                                ...
                                <p className="fs-3 fw-light fst-italic mb-5" style={{ lineHeight: '1.6' }}>
